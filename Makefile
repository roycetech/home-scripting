...
venv:
	...
	@echo "Activate your virtual environment by pasting (source venv/bin/activate):"
...
reset_router:
	@python -m scripts.router
	osascript -e 'display notification "Router reset" sound name "Glass"'
